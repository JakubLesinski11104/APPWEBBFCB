...
<%--Żródło wygladu stronywygladu strony: https://html5up.net/future-imperfect --%>
	...
	<head>
		...
		<body class="single is-preload">
			...
			<article class="post">
				<header>
				<div class="title">
							<center><h2>Szybkie newsy</h2></center>
				</div>
			</header>
...
<%
	...
	String sql ="SELECT * FROM newsy order by id desc";
